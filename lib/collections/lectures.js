...
App.Lectures.isLecturer = function(lectureCode) {
  var lecture = App.Lectures.Collection.findOne({lectureCode: lectureCode}, {fields: {lecturer: true}});
...
App.Lectures.getNumberOfStudents = function(lectureCode) {
  var lecture = App.Lectures.Collection.findOne({lectureCode: lectureCode}, {fields: {students: true}});
  if (lecture) {
