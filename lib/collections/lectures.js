...
Meteor.methods({
  ...
  lectureInsert: function(){
    ...
    var lectureId = Lectures.insert({'lectureCode': lectureCode, author: userId});
    return {
      _id: lectureId,
...
isAuthor = function(lectureCode){
 
  lecture = Lectures.findOne({lectureCode: lectureCode}, {author: true});  
